(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('pdfjs-dist/build/pdf'), require('pdfjs-dist/web/pdf_viewer')) :
    typeof define === 'function' && define.amd ? define('ng2-pdf-viewer', ['exports', '@angular/core', 'pdfjs-dist/build/pdf', 'pdfjs-dist/web/pdf_viewer'], factory) :
    (global = global || self, factory(global['ng2-pdf-viewer'] = {}, global.ng.core, global.pdf, global.pdf_viewer));
}(this, (function (exports, core, pdf, pdf_viewer) { 'use strict';

    pdf = pdf && Object.prototype.hasOwnProperty.call(pdf, 'default') ? pdf['default'] : pdf;
    pdf_viewer = pdf_viewer && Object.prototype.hasOwnProperty.call(pdf_viewer, 'default') ? pdf_viewer['default'] : pdf_viewer;
